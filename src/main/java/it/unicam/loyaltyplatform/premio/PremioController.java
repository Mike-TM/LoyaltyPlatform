...
//    public Premio getPremioById(@PathVariable Long id) throws Exception {
//
//    }
//
//    @PostMapping
//    @ResponseStatus(value = HttpStatus.CREATED, reason = "Registrazione premio avvenuta correttamente.")
//    public void registraPremio(@RequestBody PremioDTO premioDTO) throws RecordNotFoundException {
//
//    }
//
//    @DeleteMapping(path = "/{id_premio}")
//    @ResponseStatus(value = HttpStatus.OK, reason = "Cancellazione del premio.")
